...
// ✅ Message schema with tag + reactions
...
io.on('connection', (socket) => {
  socket.on('login', async (username) => {
    ...
    try {
      ...
      console.log('Error clearing lastSeen on login:', err);
    }
  ...
  socket.on('logout', async (username) => {
    ...
    try {
      ...
      console.log('Error setting lastSeen on logout:', err);
    }
  ...
  socket.on('disconnect', async () => {
    ...
    if (disconnectedUser) {
      try {
        ...
        console.log('Error setting lastSeen on disconnect:', err);
      }
    }
